...
(function () {
    ...
    bm.cv = function (bk, gP, rD) {
        // console.log("bm.cv,bk=",bk);
        // console.log("bm.cv.gp=",gP);
        // console.log("bm.cv.rD=",rD);
...
(function () {
    ...
    FO.dJ = function () {
        ...
        var Vy = function (bZ, fC, qw) {
            bA.cG(bZ, {
                type: "json", method: "POST", cookie: qw, mode: parseInt(fC) || 0, onload: function (bl) {
                    if (!this.gl)return;
    ...
    bc.Mc = function () {
        ...
        return function () {
            var bD = {}, ds = this.bs.style, lU = bb.qr(), tF = {
                left: lU.scrollLeft,
                top: lU.scrollTop
            }, cjL = {left: lU.clientWidth - this.bs.offsetWidth, top: lU.clientHeight - this.bs.offsetHeight};
...
(function () {
    ...
    bq.fX({
        ...
        "playlist-upcount": {
            url: "/api/playlist/update/playcount", type: "GET", format: function (bV, bf) {
...
(function () {
    ...
    bq.fX({
        "track-get": {
            ...
            url: "/api/v1/discovery/recommend/songs", format: function (bV) {
                var nO = [];
...
(function () {
    ...
    bn.cji = function (hJ) {
        ...
        bA.cG("/api/act/detail", {
            type: "json", method: "post", data: bm.eX({actname: hJ}), onload: function (bV) {
...
(function () {
    ...
    bq.fX({
        ...
        "search-list": {
            url: "/api/cloudsearch/get/web", type: "post", noescape: true, filter: function (bf, cj) {
...
(function () {
    ...
    bc.dm = function () {
        ...
        this.iG = {
            limit: 301,
            parent: bk[1],
            cache: {klass: bq.hW, lkey: "playlist_new-" + GUser.userId, onlisterror: this.bhs.bi(this)},
...
(function () {
    ...
    bq.fX({
        ...
        share_img_compound: {
            url: "/upload/event/img/compound", type: "POST", format: function (bp, bf) {
...
(function () {
    ...
    bc.cz = function (bf) {
        ...
        this.or = bb.rW({
            ...
            params: {flashvars: bm.BW(qI, "&", false), allowscriptaccess: "always", wmode: "transparent"}
        })
    };
    bc.cR = function () {
        this.cV();
...
(function () {
    var bd = NEJ.P, bb = bd("nej.e"), fm = bd("nej.g"), bj = bd("nej.v"), bm = bd("nej.u"), iW = bd("nej.n"), bI = bd("nej.ut"), cA = bd("nej.ui"), bT = bd("nm.w"), bo = bd("nm.l"), bq = bd("nm.d"), bn = bd("nm.x"), bL = bd("nm.x.f"), bc, bO, VL = {
        ...
        "-10": "最多只能添加4张",
        "-3": "请选择不超过5M的图片"
    }, VM = 5 * 1024 * 1024, bEM = /\.(bmp|jpg|jpeg|png|gif)$/i;
    bT.VO = NEJ.C();
    bc = bT.VO.bU(cA.gh);
    bc.dx = function () {
        ...
        var bf = {
            "com-mv-artists": function (gD, eL, AN, bdB) {
                return bb.dg("com-mv-artists", {
                    artists: gD, clazz: eL, boxClazz: bdB, mark: AN || function (dT) {
                        return dT
...
(function () {
    var bd = NEJ.P, cg = NEJ.O, bb = bd("nej.e"), ej = bd("nej.p"), bj = bd("nej.v"), bm = bd("nej.u"), bI = bd("nej.ut"), bA = bd("nej.j"), bT = bd("nm.w"), gA = bd("nm.ut"), bq = bd("nm.d"), bn = bd("nm.x"), bo = bd("nm.l"), bdC = [2, 3], eG = ["sn", "db"], bc, bO, bHG = {
        ...
        mv: " - ",
        djradio: " by "
    }, bHJ = {0: 13, 1: 17, 3: 19, 4: 18, 5: 21, 6: 24, 14: 70, 17: 20}, Aq = {
    ...
    bc.beS = function (be) {
        ...
        if (be.index == 0) {
            ...
            if (eZ == "auto" || !eZ)return; else this.iI = bT.cmY.bF({parent: document.body, target: this.hK});
    ...
    bc.bzb = function (be) {
        ...
        if (this.bJp()) {
            bn.iu({
                title: "提示", message: "是否退出本次编辑？", btnok: "退出", action: function (cl) {
                    if (cl == "ok") {
                        this.cw()
                    }
                }.bi(this)
